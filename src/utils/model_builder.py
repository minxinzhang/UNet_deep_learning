...
def get_core(dim1, dim2):
    ...
    #MODIFIED merge.concat => concat
    y = keras.layers.concatenate([d, c], axis=3)
    ...
    y = keras.layers.concatenate([e, b], axis=3)
    ...
    y = keras.layers.concatenate([f, a], axis=3)
