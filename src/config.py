...
config_vars["root_directory"] = os.getcwd() + '/data/'
...
config_vars["training_fraction"] = 0.4
config_vars["validation_fraction"] = 0.3
...
config_vars["batch_size"] = 8

config_vars["val_batch_size"] = 8
